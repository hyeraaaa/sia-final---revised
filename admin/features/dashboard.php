        ...
        <div class="container-fluid pt-5 parent">
            <div class="row g-4">
                ...
                <div class="dashboard-wrapper col-xxl-9 main-content" style="margin: 0 auto;">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-8">
                            <div class="chart-card animate__animated animate__fadeIn main-chart" style="animation-delay: 0.4s">
                        ...
                        <div class="col-md-4">
                            <div class="chart-card animate__animated animate__fadeIn main-chart" style="animation-delay: 0.5s">
                                <div class="chart-header">
