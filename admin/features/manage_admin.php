                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div id="firstNameError" class="invalid-feedback" style="display:none;">Please enter first name.</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="lastName" name="lastName">
                                    <div id="lastNameError" class="invalid-feedback" style="display:none;">Please enter last name.</div>
                                </div>
                                <div class="col-md-12">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="email" name="email">
                                    <div id="emailError" class="invalid-feedback" style="display:none;">Please enter a valid email ending with .com.</div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="contactNumber" name="contactNumber"
                                            pattern="9[0-9]{9}" title="Enter 10 digits starting with 9">
                                    </div>
                                    <div id="contactNumberError" class="invalid-feedback" style="display:none;">Contact number must start with 9 and be 10 digits long.</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="departmentError" class="invalid-feedback" style="display:none;">Please select a department.</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="roleError" class="invalid-feedback" style="display:none;">Please select a role.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div id="editFirstNameError" class="invalid-feedback" style="display:none;">Please enter your first name.</div>
                                </div>
                                <div class="col-md-6">
                                    <label for="editLastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="editLastName" name="lastName">
                                    <div id="editLastNameError" class="invalid-feedback" style="display:none;">Please enter your last name.</div>
                                </div>
                                <div class="col-md-12">
                                    <label for="editEmail" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="editEmail" name="email">
                                    <div id="editEmailError" class="invalid-feedback" style="display:none;">Please enter a valid email ending with .com.</div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div id="editContactNumberError" class="invalid-feedback" style="display:none;">Contact number must start with 9 and be 10 digits long.</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="editDepartmentError" class="invalid-feedback" style="display:none;">Please select a department.</div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div id="editRoleError" class="invalid-feedback" style="display:none;">Please select a role.</div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
            ...
            $(document).ready(function() {
                $('#editAdminForm').on('submit', function(e) {
                    ...
                    if (!contactPattern.test(contactNumber)) {
                        ...
                        $('#editContactNumberError').show();
                    } else {
                        $('#editContactNumber').removeClass('is-invalid');
                        $('#editContactNumberError').hide();
                    }
