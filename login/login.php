...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="pics/brand.png">
</head>
            ...
            <div class="row align-items-center">
                <div class="col-3">
                    <img
                        ...
                        class="img-fluid"
                        width="150"
                        height="auto" style="max-height: 110px; max-width:110px;">
                </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="login_form" action="login_script.php" method="POST">
                                ...
                                <?php if (isset($_GET['message'])): ?>
                                    <div class="alert alert-success py-2"><?php echo htmlspecialchars($_GET['message']); ?></div>
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            setTimeout(function() {
                                                document.querySelector(".alert").style.display = "none";
